    ...
    <div class="container-fluid">
      ...
      <div class="card" v-show="!detalle">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Búsqueda Horas Extra
      ...
      <div class="card" v-show="!detalle">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Horas Extra
        </div>
        <div class="card-body">
      ...
      <div class="card" v-show="detalle">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Horas extra pertenecientes a : {{ empleado == null ? '': empleado.nombre + ' ' + empleado.ap_paterno + ' ' + empleado.ap_materno }} del {{fechaInicial}} al {{fechaFinal}}
...
export default {
  data(){
    return {
      ...
      columnsRetardo : ['fecha','dia','total_horas_extras','horas_trabajadas','hora_entrada','hora_salida'],
      tableData: [],
      listaProyectos : [],
      listaEmpresas : [],
      tableDataRetardo : [],
  ...
  methods: {
    ...
    descargar() {
        this.$validator.validate().then(result => {
            if (result) {
                window.open('descargarhorasextra/' + this.fechaInicial + '&' + this.fechaFinal + '&' + this.proyectoId + '&' + this.empresaId, '_blank' );
            }
        });
    }
