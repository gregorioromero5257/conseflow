      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-group row">
            <label class="col-md-2 form-control-label" for="tipo_partida"><br>Proyecto</label>
            <div class="col-md-4">
              <label>&nbsp;</label>
        ...
        <!-- <div class="form-group row">
          ...
          <label class="col-md-2 form-control-label" for="tipo_partida"><br>Proveedor</label>
          <div class="col-md-4">
            <label>&nbsp;</label>
  ...
  methods:{
    ...
    listarCompras(){
      if (this.proyecto == '' && this.proveedor == '') {
        ...
        axios.get(`trazabilidadcompras/historico/${tipo}&${ids}`).then(response => {
    ...
    generarExcel(){
      if (this.proyecto == '' && this.proveedor == '') {
        ...
        window.open(`descargar-excel-historico-compras-final/${this.proyecto.id}` , '_blank');
      }
