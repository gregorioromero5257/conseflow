            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-control">
                        <input type="file" v-validate="'required|ext:xls,xlsx,csv'" data-vv-as="Archivo" name="import_file"
                               @change="getArchivo" accept="*/*" required>
            ...
            updateAvatar() {
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        ...
                        axios.post('/transfer/upload', data)
                            .then(response => {
                                this.archivo = null;
