    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Subir sueldos semanales
        </div>
        <div class="card-body">
          <div class="form-row">
        ...
        <div class="card-body">
          ...
          <v-client-table :data="sueldosDatosDos" :options="optionsdos" :columns="columnsdos" ref="dos">
            <template slot="t.total" slot-scope="props">
              {{(parseFloat(props.row.t.total) - parseFloat(props.row.t_r.total)).toFixed(2)}}
            </template>
          </v-client-table>
          </div>
  ...
  methods: {
    ...
    getData() {
      ...
      update(){
            ...
            axios.post('/registrosueldossemanales/upload',data)
            .then(response => {
