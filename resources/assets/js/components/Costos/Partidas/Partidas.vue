                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" id="tipo_partida"  name="tipo_partida" v-model="partida.tipo_partida_id"  data-vv-name="Tipo de partida" v-validate="'excluded:0'" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-validate="'required'" name="nombre" v-model="partida.nombre" class="form-control" placeholder="Nombre del tipo de partida" autocomplete="off" id="nombre" data-vv-name="Nombre">
                                <span class="text-danger">{{ errors.first('nombre') }}</span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="nombre">Folio</label>
                            <div class="col-md-9">
                                <input type="text" v-validate="'required'" name="folio" v-model="partida.folio" class="form-control" placeholder="Folio" autocomplete="off" id="nombre" data-vv-name="Nombre">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-validate="'required|decimal:2'" name="monto_cotizado" v-model="partida.monto_cotizado" class="form-control" placeholder="Monto cotizado" autocomplete="off" id="monto_cotizado" data-vv-name="Monto cotizado">
                                <span class="text-danger">{{ errors.first('monto_cotizado') }}</span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="moneda">Moneda</label>
                            <div class="col-md-9">
                                <select class="form-control" v-model="partida.moneda" data-vv-name="Moneda" v-validate="'required'">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-validate="'required|decimal:2'" name="monto_ejecutado" v-model="partida.monto_ejecutado" class="form-control" placeholder="Monto ejecutado" autocomplete="off" id="monto_ejecutado" data-vv-name="Monto ejecutado">
...
export default {
    data (){
        return {
            ...
            tableData: [],
            columns: [
                'id','nombre','folio','tipo_partida', 'monto_cotizado'
            ],
            tableData: [],
            options: {
                headings: {
        ...
        abrirModal(accion, data = []){
            switch(accion){
                ...
                case 'actualizar':
                {
                    ...
                    this.partida.moneda = data['moneda'];
                    break;
                }
            }
        },
