        ...
        <div class="card-body">
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" v-model="tipoCambio">
              <span class="text-danger">{{ errors.first('Tipo Cambio') }}</span>
            </div>
...
export default {
  ...
  methods :{
    ...
    descargar(){
      if (this.tipoCambio === '') {
        toastr.warning('Determine el tipo de cambio antes de descargar');
      }else {
        window.open(`descargar-excel-estatus-de-material-requisitado/${this.proyecto_id.id}&${this.tipoCambio}` , '_blank');
      }
    },
