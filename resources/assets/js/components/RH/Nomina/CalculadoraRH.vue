...
{{contador}} -->
          <div class="form-row">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(parseFloat(data.final) + parseFloat(data.couta_patronal) ).toFixed(2)}}</h6></span>
              </div>
            </div>
              <hr>
...
export default {
  ...
  methods : {
    ...
    //   //this.data.factor_calculos = (uno + dos + tres) / parseFloat(this.data.dias_t);
    //
    // },
...
// 11.63
    ...
    calculo_Dias(){
      var dia;
      if(this.data.rango === 'dias'){
        dia = this.data.dias_t;
      }else if (this.data.rango === 'meses') {
        var dia_meses = Math.trunc(this.data.dias_t * 30.4);
        dia = dia_meses;
      }else if (this.data.rango === 'anios') {
        var dia_anios = Math.trunc(this.data.dias_t * 365);
        dia = dia_anios;
      }
    ...
    resetValues () {
      ...
      this.data.costo_total_trabajador = 0;
    ...
    updateSalary() {
          ...
          this.data.couta_patronal = this.calcCuotaP(this.data.sbc);
          this.data.costo_total_trabajador = parseFloat(this.data.final) + parseFloat(this.data.couta_patronal);
          // this.data.finiquito = this.finiquito();
