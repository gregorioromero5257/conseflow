...
class SemanaExportFin implements FromView, ShouldAutoSize, WithEvents
{
    protected $id;
    ...
    public function view(): View
    {
      ...
      ->select('P.*')
      ->where('C.tipo_nomina_id','=','1')->where('nominas_movimientos.nomina_id','=',$this->id)->distinct()->get();
      ...
      // $empleados = \App\
        ...
        return view('excel.semanaluno', compact('contratosp','arreglo','contrat_to','contra_to','contr_to','nomina'));
    }
}
