    ...
    export default {
        data (){
            return {
                ...
                tipoAccion : 0,
                isLoading: false,
                columns: ['uuid', 'uuid_relacionado', 'ordenCompra', 'entradaFecha'],
                tableData: [],
                listafactura: [],
                listaEmpleados: [],
                options: {
                    ...
                    sortable: ['uuid', 'uuid_relacionado', 'ordenCompra', 'entradaFecha'],
                    filterable: ['uuid', 'uuid_relacionado', 'ordenCompra', 'entradaFecha'],
                    filterByColumn: true,
                    texts:config.texts
                },
            }
        ...
        methods : {
            getData() {
                ...
                let me=this;
                axios.get('/reportefactura').then(response => {
