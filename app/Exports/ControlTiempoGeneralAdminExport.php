...
class ControlTiempoGeneralAdminExport implements FromView, ShouldAutoSize, WithEvents
{
  protected $id;
  ...
  public function view(): View
  {
    ...
    return view('excel.controltiempogeneraladmin', compact('arreglo_uno','arreglo_uno_dos','a'));
  }
