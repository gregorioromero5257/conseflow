...
<div class="card border-dark">
    ...
    <div class="card-header bg-dark text-white">
        <i class="fa fa-align-justify"> </i> Precios de artículos
    </div>
    <div class="card-body">
...
export default
{
    data()
    {
        return {
            ...
            list_articulos: [],
            columns_articulos: ["proyecto","fecha", "descripcion", "marca","cantidad", "grupo"],
            options_articulos:
            {
                headings:
                {
                    ...
                    if (result.value)
                    {
                        ...
                        if (result.value != "")
                        {
                            ...
                            axios(
                            {
                                ...
                                data:
                                {
                                    articulo_id: data.row.a_id,
                                    req_id: data.row.req_id,
