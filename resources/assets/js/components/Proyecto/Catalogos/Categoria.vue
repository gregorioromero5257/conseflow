            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="abrirModal('categoria','registrar')" class="btn btn-dark float-sm-right">
                        ...
                        <v-client-table :columns="columns" :data="tableData" :options="options" ref="myTable">
                            <template slot="id" slot-scope="props">
                              <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                ...
                                <button type="button" @click="abrirModal('categoria','actualizar',props.row)" class="dropdown-item" >
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-validate="'required'" name="nombre" v-model="categoria.nombre" class="form-control" placeholder="Nombre de categoría" autocomplete="off" id="nombre">
...
var config = require('../../Herramientas/config-vuetables-client').call(this);
    ...
    export default {
        ...
        methods : {
            getData() {
                let me=this;
                axios.get('/procategoria').then(response => {
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        ...
                        axios({
                            ...
                            url: nuevo ? '/procategoria/registrar' : '/procategoria/actualizar',
                            data: {
