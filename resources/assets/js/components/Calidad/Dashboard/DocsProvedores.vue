...
export default
{
    ...
    methods:
    {
        ...
        {
            axios
                .get("/conta/facturasproveedores/obtenerprogramados/=&2")
                .then((res) =>
                {
                    if (res.data.status)
                    {
            ...
            }).then((result) =>
            {
                ...
                if (!valido) // Rechazado
                {
                    ...
                    }).then(ms =>
                    {
                        ...
                        this.GuardarEstado(id, 0, "CALIDAD: " + ms.value);
                    });
                }
                else
                {
        ...
        {
            let aux_mensaje = estado == 3 ? "autorizada" : "rechazada";
            axios
