...
class EstatusMaterialRequisitadoExport implements FromView, WithEvents
{
  protected $id;
  ...
  */
  public function registerEvents(): array
  {
    ...
    return [
      ...
      AfterSheet::class => function (AfterSheet $event) use ($styleArray) {
        ...
        $event->sheet->getStyle('A5:Z5')->applyFromArray($styleArray[1]);//se lllama el array de la posicion 0
        $event->sheet->getStyle('A6:Z6')->applyFromArray($styleArray[1]);//se lllama el array de la posicion 0
  ...
  public function view(): View
  {
    ...
    $valores = explode('&',$this->id);
            ...
            foreach ($pr as $key => $value) {
              ...
              ->select('rhoc.id','oc.folio','rhoc.articulo_id','rhoc.cantidad','oc.periodo_entrega','oc.moneda',
                'rhoc.precio_unitario','rhoc.comentario','p.razon_social','oc.fecha_orden')
    ...
    return view('excel.requisitadocompradodos', compact('arreglo'));
  }
}
