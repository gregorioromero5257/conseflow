    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button v-show="PermisosCrud.Create" type="button" @click="abrirModal('pagos','registrar')" class="btn btn-dark float-sm-right">
        ...
        <div class="card-body">
          ...
          <v-client-table ref="myTable" :columns="columns" :data="tableData" :options="options">
            <template slot="id" slot-scope="props">
              ...
              <button v-show="PermisosCrud.Update" type="button" @click="abrirModal('pagos','actualizar',props.row)" class="dropdown-item">
          ...
          <div class="modal-body">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                data-vv-name="banco" @change="buscarBanco(pagos.banco_contabilidad_id)" >
