...
<head>
        ...
        <div class="Cell" style="padding-top: -20px;">
          <table class="ord">
            ...
            <tr>
              ...
              font-family: Arial, Helvetica, sans-serif;
              text-align: center; background-color: #d2caca"><b>ENTRADA ALMACEN</b> </th>
            </tr>
            <tr>
              <td></td>
            </tr>
            ...
            <tr>
              <td>&nbsp;&nbsp;<b>ORDEN DE COMPRA:</b>&nbsp;{{$arreglo_partidas[0]['partidas'][0]->foliocompra}} </td>
            </tr>
            <tr>
              <td>&nbsp;&nbsp;<b>PROYECTO:</b>&nbsp;{{$arreglo_partidas[0]['partidas'][0]->foliocompra}} </td>
            </tr>
            <tr>
              <td></td>
            </tr>
  ...
  <table width="100%" style="text-align: center;">
    ...
    <tr>
      ...
      font-size: 12px;
      font-family: Arial, Helvetica, sans-serif"><b>Almacén</b></td>
      <td>&nbsp;</td>
      <td style="border-top: 1px solid; font-size: 12px;
      font-family: Arial, Helvetica, sans-serif"><b>Usuario</b></td>
      <td>&nbsp;</td>
      <td style="border-top: 1px solid; font-size: 12px;
      font-family: Arial, Helvetica, sans-serif"><b>Calidad</b></td>
    </tr>
  </table>
