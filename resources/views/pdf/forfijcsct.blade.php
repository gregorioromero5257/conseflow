...
<head>
  ...
  <body>
        <div class="Table" style="padding-top: 0px">
                ...
                <div class="Row">
                        <div class="Cell">
                            <p class="cons" style="padding-top: -30px;"><b> CONSTRUCTORA Y SERVICIOS CALDERONTORRES SA DE CV </b> <br>
                              <b>RFC:</b> CSC050609LF7 <br>
                              <b>DIRECCIÓN:</b>Av. Francisco I. Madero 1000,<br> Ma. de la Piedad, C.P. 96410 <br>Coatzacoalcos, Ver
                            </p>
                        </div>
