...
<script type="text/babel">
  import pointerScroll from '../Herramientas/mixins/pointerScroll'
  import typeAheadPointer from '../Herramientas/mixins/typeAheadPointer'
  import ajax from '../Herramientas/mixins/ajax'
