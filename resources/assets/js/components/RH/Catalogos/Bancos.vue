                ...
                <div class="modal-dialog modal-dark modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="id">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-validate="'required|max:45'" name="nombre" v-model="banco.nombre" class="form-control" placeholder="Nombre del Banco" autocomplete="off" id="nombre">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-secondary" @click="guardarBanco(1)"><i class="fas fa-save"></i>&nbsp;Guardar</button>
    ...
    export default {
        ...
        methods : {
            ...
            cerrarModal(){
                this.modal=0;
                this.tituloModal='';
                Utilerias.resetObject(this.banco);
            },
