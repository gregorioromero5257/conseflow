...
class NominaSExport implements FromView, ShouldAutoSize
{
  protected $id;
  ...
  public function view(): View
  {
    ...
    if ($fecha_inicial == 'null' && $fecha_final == 'null' && $proyecto_id == 0) {
      ...
      if ($tipo == 1) {
        $nominas = DB::table('nomina')->select('nomina.*')->where('nomina.tipo_nomina','=','2')->get();
        foreach ($nominas as $key => $value) {
          ...
          )->where('C.tipo_nomina_id','=','1')->where('nominas_movimientos.nomina_id','=',$value->id)->get();
          $sumauno = DB::table('nominas_movimientos')
          ->leftJoin('empleados AS E','E.id','=','nominas_movimientos.empleado_id')
          ->leftJoin('contratos AS C','C.id','=','nominas_movimientos.contrato_id')
          ->select(DB::raw('SUM(nominas_movimientos.efectivos) AS suma') )->where('C.tipo_nomina_id','=','1')->where('nominas_movimientos.nomina_id','=',$value->id)->first();
          $arreglo [] =
          [
            'nominas' => $value,
            'movimientos' => $nomina,
        ...
        ->select(DB::raw('SUM(nominas_movimientos.efectivos) AS suma') )->where('C.tipo_nomina_id','=','1')->first();
      }
      ...
      if ($tipo == 2) {
        ...
        foreach ($nominas as $key => $value) {
          ...
          ->leftJoin('empleados AS E','E.id','=','nominas_movimientos.empleado_id')
          ->leftJoin('contratos AS C','C.id','=','nominas_movimientos.contrato_id')
          ->select(DB::raw('SUM(nominas_movimientos.transferencias) AS suma') )->where('C.tipo_nomina_id','=','1')->where('nominas_movimientos.nomina_id','=',$value->id)->first();
          $arreglo [] =
          [
            'nominas' => $value,
            'movimientos' => $nomina,
        ...
        ->leftJoin('contratos AS C','C.id','=','nominas_movimientos.contrato_id')
        ->leftJoin('nomina AS N','N.id','=','nominas_movimientos.nomina_id')
        ->select(DB::raw('SUM(nominas_movimientos.transferencias) AS suma') )->where('C.tipo_nomina_id','=','1')->first();
      }

    }
    if ($fecha_inicial == 'null' && $fecha_final == 'null' && $tipo == 0) {
      $condicion = 2;
      $nomina = DB::table('nomina')->select('nomina.*')->where('nomina.tipo_nomina','=','2')->get();
      foreach ($nomina as $key => $value) {
        ...
        )->where('C.tipo_nomina_id','=','1')->where('nominas_movimientos.nomina_id','=',$value->id)->where('P.id','=',$proyecto_id)->get();
        $sumauno = DB::table('nominas_movimientos')
        ->leftJoin('empleados AS E','E.id','=','nominas_movimientos.empleado_id')
        ->leftJoin('contratos AS C','C.id','=','nominas_movimientos.contrato_id')
        ->leftJoin('proyectos AS P','P.id','=','nominas_movimientos.proyecto_id')
        ->select(DB::raw('SUM(nominas_movimientos.transferencias) AS sumat'),DB::raw('SUM(nominas_movimientos.efectivos) AS sumae') )
        ->where('C.tipo_nomina_id','=','1')->where('nominas_movimientos.nomina_id','=',$value->id)->where('P.id','=',$proyecto_id)->first();
        if (count($nomina) != 0) {
          $arreglo [] =
          [
            'nominas' => $value,
    ...
    if ($proyecto_id == 0 && $tipo == 0) {
      ...
      ->where('nomina.tipo_nomina','=','2')->get();
      foreach ($nomina as $key => $value) {
        $nomina = DB::table('nominas_movimientos')
        ->leftJoin('empleados AS E','E.id','=','nominas_movimientos.empleado_id')
        ->leftJoin('contratos AS C','C.id','=','nominas_movimientos.contrato_id')
        ...
        ->leftJoin('proyectos AS P','P.id','=','nominas_movimientos.proyecto_id')
        ->select(DB::raw('SUM(nominas_movimientos.transferencias) AS sumat'),DB::raw('SUM(nominas_movimientos.efectivos) AS sumae') )
        ->where('C.tipo_nomina_id','=','1')->where('nominas_movimientos.nomina_id','=',$value->id)->first();
        $arreglo [] = [
          'nominas' => $value,
          'movimientos' => $nomina,
          'suma' => $sumauno,
    ...
    return view('excel.nominas', compact('condicion','nomina','tipo','suma','arreglo','fecha_inicial','fecha_final','condiciontrestexto'));
  }
}
