            ...
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
              <div class="btn-group dropup" role="group">
                ...
                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                  ...
                  <button type="button" @click="eliminar('viaticos','actualizar',props.row)" class="dropdown-item" v-show="estado_vista == 1">
...
export default {
  data(){
    return {
      ...
      empresa : '',
      columns : ['id','fecha_pago','importe_te','importe_efectivo','beneficiario','descargar'],
      data : [],
      detalle : null,
      listaBeneficiarios : [],
      options : {
