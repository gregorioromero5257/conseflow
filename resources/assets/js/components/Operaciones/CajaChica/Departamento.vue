                        ...
                        <div class="modal-body">
                            <!-- <form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-validate="'required|max:100'" name="nombre" readonly v-model="departamento.nombre" class="form-control" placeholder="Nombre del departamento" autocomplete="off" id="nombre">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="direccion_administrativa_id" readonly name="direccion_administrativa_id" v-model="departamento.direccion_administrativa_id" v-validate="'excluded:0'" data-vv-as="Dirección administrativa">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="nombre">Empleado responsable</label>
                                    <div class="col-md-9">
                                      <v-select :options="optionsvs" v-validate="'required'" v-model="departamento.empleado_responsable_id" label="name" data-vv-name="empleado" ></v-select>
                    ...
                    if (result) {
                        ...
                        axios({
                            ...
                            data: {
                                ...
                                'empleado_responsable_id' : this.departamento.empleado_responsable_id.id,
                            }
                    ...
                    case "departamento":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                                ...
                                this.departamento.empleado_responsable_id = {id : data['empleado_responsable_id'], name : data['empleado_responsable_nombre']};
                                break;
                            }
                        }
                    }
