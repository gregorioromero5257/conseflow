...
class TrazabilidadSoldadurasController extends Controller
{
    //
    ...
    public function pdf ($id){
      ...
      ->select('partidas_inspeccion.*','S.num','S.nombre as nombre_soldador','S.numero_serie_maquina','MSS.soldadura','MSS.material_uno AS material_uno_n',
      ...
      $totalfinal = ($totalpaginas * 9) - $tamanio;
        ...
        $pdf = PDF::loadView('pdf.trazabilidad', compact('trazabilidad','inspeccion','partidas','tamanio','totalpaginas','totalfinal'));
