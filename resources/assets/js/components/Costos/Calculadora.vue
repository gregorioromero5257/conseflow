    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Calculadora sueldo
        </div>
        <div class="card-body">
          <!-- <div class="form-row">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" v-model="data.dias_t" class="form-control" name="" value="" v-validate="'required|decimal'" data-vv-name="Dias" >
              <span class="text-danger">{{errors.first('Dias')}}</span>
            </div>

            <div class="form-group col-md-2">
              <label>Sueldo diario neto</label>
            ...
            <div class="form-group col-md-2">
              <label>Año</label>
              <select class="form-control" v-validate="'required'" data-vv-name="año" v-model="data.anio">
          ...
          <div class="form-row">
            <div class="form-group col-md-3">
              <label>Puestos</label>
              <select class="form-control" v-model="data_response.puesto_id" @change="mostrar()">
                <option v-for="t in puestos"  :key="t.id" :value="t.id">{{t.nombre}}</option>
              </select>
            </div>
            <template v-if="mostrar_boton == 1">
              <div class="form-group col-md-2">
                <label>&nbsp;</label>
                <button type="button" class="form-control" name="button" @click="guardar()"><i class="fas fa-save"></i>Guardar</button>
              </div>
            </template>
          </div>
          ...
          <template v-if="data_response != ''">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> SALARIO SEMANAL&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{Math.round(this.data_response.salario_semana).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> SALARIO DIARIO&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.salario_diario) }}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> SALARIO DÍAS TRABAJADOS&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.salario_mensual).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> ISR &nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.isr_mensual).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> IMSS (TRABAJADOR)&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.imss_infonavit_trabajador).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> IMSS (EMPRESA)&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.imss_infonavit_empresa).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.finiquito_mensual).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> IMPUESTO AL ESTADO 3%&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.impuesto_estado).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> SALARIO TOTAL&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.salario_mensual_cal).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> SALARIO DIARIO CON TODAS LAS PRESTACIONES&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>$&nbsp;{{(this.data_response.salario_prestaciones).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
            <div class="form-row">
              <div class="form-group col-md-4">
                <span class="text"><h6> FACTOR&nbsp;</h6></span>
              </div>
              <div class="form-group col-md-4">
                <span class="text"><h6>&nbsp;{{(this.data_response.factor).toFixed(2)}}</h6></span>
              </div>
            </div>
            <hr>
          ...
          <v-client-table ref="myTable" :columns="columns" :data="tableData" :options="options">
            <template slot="id" slot-scope="props">
              <button class="btn btn-outline-dark" name="button" @click="editar()"><i class="fas fa-pencil-alt"></i></button>
              <button class="btn btn-outline-dark" name="button" @click="eliminar(props.row.id)"><i class="fas fa-trash"></i></button>
...
export default {
  data (){
    return {
      columns: [
        'id','nombre','salario_diario','isr_mensual','imss_infonavit_trabajador','finiquito_mensual'
      ],
      tableData: [],
      data_response : {
        salario_semana : 0,
        ...
        salario_mensual : 0,
        isr_mensual : 0,
        imss_infonavit_trabajador : 0,
        imss_infonavit_empresa : 0,
        finiquito_mensual : 0,
        impuesto_estado : 0,
        salario_mensual_cal : 0,
        salario_prestaciones : 0,
        salario_imss : 0,
        diferencia : 0,
        puesto_id : '',
        factor : 0,
      ...
      options: {
          headings: {
            ...
            'imss_infonavit_trabajador' : 'IMSS',
            'finiquito_mensual' :'Finiquito Mensual',
          },
          perPage: 10,
          perPageValues: [],
          skin: config.skin,
  ...
  methods : {
    ...
    getData(){
      ...
      // axios.get('calculadora/neto/bruto/12').then(response => {
      //   console.log(response);
      // }).catch(e => {
      //   console.error(e);
      // });
      axios.get('get/sueldos/costos/').then(response => {
    ...
    eliminar(id){
      axios.get('eliminar/sueldos/costos/' + id).then(response => {
        this.getData();
    ...
    guardar(){
      if(this.data_response.salario_semana == 0){
        toastr.warning('Calcule datos antes de guardar');
      }else {
        axios.post('/sueldos_costos', this.data_response)
        .then(response => {
          let me = this;
          me.getData();
          Utilerias.resetObject(this.data_response);
    ...
    validar_tamanio(){
      if(this.data.dias_t > 365){
        toastr.warning('Los dias no pueden sobrepasar los 365 dias');
        this.data.dias_t = '';
      }
    },

    cambio(){
    this.data.inicial = (30.4 * this.data.sueldo_bruto_d).toString();
    },
...
// 11.63
    ...
    resetValues () {
      ...
      this.data.finiquito = 0;
      this.data.sueldo_bruto_d = 0;
      this.data.dias_t = '';
      this.data.costo_diario_trabajador = 0;
      this.puesto_id = '';
    ...
    updateSalary() {
      this.$validator.validate().then(result => {
        if (result) {
          ...
          axios.get('calculadora/neto/bruto/' + this.data.dias_t + '&' + this.data.sueldo_bruto_d + '&' + this.data.anio ).then(response => {
            console.log(response);
            // this.data_response = response.data;
            this.data_response.salario_semana =  this.data.sueldo_bruto_d * 7;
            this.data_response.salario_diario =  this.data.sueldo_bruto_d;
            this.data_response.salario_mensual =  this.data.sueldo_bruto_d * this.data.dias_t;
            this.data_response.isr_mensual = (response.data['isr']['isr_cargo'] / 30) * this.data.dias_t;
            this.data_response.imss_infonavit_trabajador = response.data['imss']['imss'];
            this.data_response.imss_infonavit_empresa = response.data['patron']['couta_patronal'];
            this.data_response.finiquito_mensual = response.data['finiquito']['finiquito'];
            this.data_response.impuesto_estado = ( (this.data.sueldo_bruto_d * this.data.dias_t) +  response.data['finiquito']['finiquito'] ) * 0.03;

            this.data_response.salario_mensual_cal =
            (this.data.sueldo_bruto_d * this.data.dias_t) +
            ((response.data['isr']['isr_cargo'] / 30) * this.data.dias_t) +
            (response.data['imss']['imss']) +
            (response.data['patron']['couta_patronal']) +
            (response.data['finiquito']['finiquito']) +
            (( (this.data.sueldo_bruto_d * this.data.dias_t) +  response.data['finiquito']['finiquito'] ) * 0.03);
            var uno =   (this.data.sueldo_bruto_d * this.data.dias_t) +
              ((response.data['isr']['isr_cargo'] / 30) * this.data.dias_t) +
              (response.data['imss']['imss']) +
              (response.data['patron']['couta_patronal']) +
              (response.data['finiquito']['finiquito']) +
              (( (this.data.sueldo_bruto_d * this.data.dias_t) +  response.data['finiquito']['finiquito'] ) * 0.03);
            //
            this.data_response.salario_prestaciones = uno / this.data.dias_t;
            this.data_response.factor = 1 + ((this.data.sueldo_bruto_d * this.data.dias_t) / (uno));
        ...
        // this.data.couta_patronal = this.calcCuotaP(this.data.sbc);
        // // this.data.costo_total_trabajador = parseFloat(this.data.final) + parseFloat(this.data.couta_patronal) + parseFloat(this.data.finiquito);
        // this.data.costo_diario_trabajador = (((((parseFloat(this.data.final) + parseFloat(this.data.couta_patronal))/30.4) * parseFloat(this.data.dias_t)) + parseFloat(this.data.finiquito)) / parseFloat(this.data.dias_t)).toFixed(2);
        // this.isLoading = false;
        //
        //
