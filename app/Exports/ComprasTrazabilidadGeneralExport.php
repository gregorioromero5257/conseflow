...
class ComprasTrazabilidadGeneralExport implements FromView, WithEvents
{
  protected $id;
  ...
  */
  public function registerEvents(): array
  {
    ...
    $total = (count($total_columnas) + 1) * 2;
    $styleArray = [
  ...
  public function view(): View
  {
    ...
    return view('excel.comprasgeneraltrazabilidad', compact('arreglo'));
  }
}
