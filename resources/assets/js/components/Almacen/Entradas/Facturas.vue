  ...
  <div>
    <div class="card">
      <div class="card-header">
        <i class="fa fa-align-justify"></i> Facturas de la entrada
...
export default {
  data() {
    return {
      ...
      cat_imp : [],
      tipoAccion : 0,
      columns : ['id','proveedor_name','uuid','total','descripcion','comprobante'],
      options: {
        headings: {
          'id': 'Acciones',
  ...
  methods : {
    ...
    **/
    ...
    getData(data){
      console.log(data);
      var valor = 'Entrada';
      axios.get(`facturasentradas/${data.id}&${valor}&${data.orden_compra_id}`).then(response => {
