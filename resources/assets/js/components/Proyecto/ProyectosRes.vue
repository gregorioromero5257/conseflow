               ...
               <download-excel
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenu2" v-model="empresa">
                    <button class="dropdown-item" type="button" @click="empresa = 1;listar();">Conserflow</button>
                    <button class="dropdown-item" type="button" @click="empresa = 2;listar();">Constructora</button>
                  </div>
                </div>
            </div>
            <div class="card-body">
                  ...
                  Adicional
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        <template v-if="props.row.documento_po == null">
                          <a v-show="PermisosCrud.Upload" class="dropdown-item" @click="subirDocumento(props.row,1)" href="#">
                        ...
                        <template v-if="props.row.documento_po != null">
                          <a v-show="PermisosCrud.Download" class="dropdown-item" @click="abrirModalPDF(props.row.documento_po)" href="#">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form" v-if="tipoAccion==1">
                        ...
                        <div class="form-group row">
                          <label class="col-md-2 " for="text-input">Empresa</label>
                          <div class="col-md-4">
        ...
        methods : {
            ...
            listar(){
             ...
             this.PermisosCrud = Utilerias.getCRUD(this.$route.path)
                axios.get('/proyecto-listar-todos-empresa/' + this.empresa).then(response => {
            ...
            abrirModalPDF(archivo){
                var method = 1;
                axios.get('/proyecto-obtenerarchivos/'+ method + '&' + archivo).then(response => {
                    //console.log(response.data);
                }).catch(error => {
                    console.error(error);
                });
                this.nombre_archivo = 'FilesFTP/' + archivo;
                this.nombre_archivo2 = archivo;
                this.modalPDF = 1;
            },

            cerrarModalPDF(){
                var method = 2;
                axios.get('/proyecto-obtenerarchivos/'+ method + '&' + this.nombre_archivo2).then(response => {
                    //console.log(response.data);
                }).catch(error => {
                    console.error(error);
                });
