<template>
  <div class="card border-secondary">
    ...
    <div class="card-header bg-dark text-white">
      <i class="fa fa-align-justify"> </i> Solicitudes de viaticos por autorizar: {{solicituds == [] ? '' :  solicituds.folio}}
            ...
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
              <div class="btn-group dropup" role="group">
                ...
                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                  <!-- <button type="button" @click="detalles(item.solicitud.id)" class="dropdown-item" >
                    <i class="fas fa-eye"></i>&nbsp;Detalles
                  </button> -->
                  <button type="button" @click="enviarautorizar(item.solicitud.id, 4)" class="dropdown-item" >
    ...
    <table class="VueTables__table table table-hover table-sm" v-show="detalle">
      <tbody>
        ...
        <tr>
          ...
          <th scope="row">Hora estimada de saida:</th>
...
export default {
  ...
  methods: {
    getData() {
      this.isLoading = true;
      let me=this;
      axios.get('/viaticosporautorizar').then(response => {
        ...
        if (result.value){
          ...
          axios.post('/estadosviaticos',{
            ...
            if (edo == 4) {
              ...
              this.isLoading = false;
              toastr.success('Solicitud de viaticos autorizada','Correcto');
              this.getData();
